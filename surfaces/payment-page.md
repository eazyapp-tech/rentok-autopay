...
**R64 is still not in the decision log.** His 22 September charge ruling is written into
`surfaces/manager-app.md` section 7 and here in section 7, and it needs to be added as a ruling or
confirmed as already covered by R35 and R63. Product rulings are his and are never quietly edited.
